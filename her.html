	<div id="popup-template">
    	...
    	<!--PHOTO-ITEM-->
       	<div class="photo-item">
      		...
      		<!--PHOTO-->
            <div id="main-image" class="autocrop-image" style="background-image:url(images/profile-her-popup.jpg)">
            </div>
        	...
        	<div class="layer wh100 photo-caption">
                ...
                <div id="popup-template-title-wrapper">
               		<h1 style="color:#FFF">DIANNE ANNA</h1>
